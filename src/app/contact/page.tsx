            ...
            <div className="bg-white rounded-lg shadow-xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <svg className="h-6 w-6 text-secondary-500 mt-1 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                  </svg>
                  <a href="mailto:mike.nielson@apexnovaconsulting.com" className="text-gray-600 hover:text-secondary-500">
                ...
                <div className="flex items-start">
                  ...
                  <a href="tel:973-348-5008" className="text-gray-600 hover:text-secondary-500">
                    (973) 348-5008
                  </a>
                </div>
              </div>
